//! The prototype page, over the scenario runtime. The served page of D11 is
//! built in `flywheel-surface` over the state store alone; this is what the
//! `flywheel page` command has served since before group 7 and it goes when
//! that page lands. One axum process serves the rail and the
