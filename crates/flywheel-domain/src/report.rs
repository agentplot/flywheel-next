...
//! runner will call it unchanged. The page's curator surface reports through
//! this same function rather than a path of its own, so what the operator
//! submits there and what `flywheel exit` writes are one record (67, 93b, D16).
